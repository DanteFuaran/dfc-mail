...
from src.database.models import User, ReferralTransaction
from src.bot.keyboards import get_main_menu_keyboard, get_back_keyboard
from src.bot.texts import get_referral_text, MENU_REFERRAL
